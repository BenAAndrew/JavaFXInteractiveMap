...
Includes leap motion lib (only needed if using leap motion controller). All code in this folder belongs to Leap Motion and can be downloaded in their SDK too.
